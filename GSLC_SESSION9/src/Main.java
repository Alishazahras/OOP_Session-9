		...
		if(user.isEmpty()) {
			...
			for(User A : user) {
				...
				if(A instanceof MemberUser) {
					System.out.printf("%-4s | %-15s | %-10s | %-10s | %-8s | %-10s | %-10s | %-15s | %-15s | %-20s |\n", counter, A.getName(), A.getGender(), A.getStatus(), A.getPoint(), ((MemberUser)A).calcID(), ((MemberUser)A).ktp.getNoKTP(), ((MemberUser)A).getAddress(), ((MemberUser)A).getUsername(), ((MemberUser)A).getEmail());
				}else if(A instanceof NormalUser) {
					System.out.printf("%-4s | %-15s | %-10s | %-10s | %-8s | %-10s | %-10s | %-15s | %-15s | %-20s |\n", counter, A.getName(), A.getGender(), A.getStatus(), A.getPoint(), " - ", ((NormalUser)A).ktp.getNoKTP(), " - ", " - " , " - ");
				}
			}
	...
	private void delete() {
		...
		if(user.isEmpty()) {
			...
			for(User A : user) {
				counter++;
				if(A instanceof MemberUser) {
					System.out.printf("%-4s | %-15s | %-10s | %-10s | %-8s | %-10s | %-10s | %-15s | %-15s | %-20s |\n", counter, A.getName(), A.getGender(), A.getStatus(), A.getPoint(), ((MemberUser)A).calcID(), ((MemberUser)A).getKtp(), ((MemberUser)A).getAddress(), ((MemberUser)A).getUsername(), ((MemberUser)A).getEmail());
				}else if(A instanceof NormalUser) {
					System.out.printf("%-4s | %-15s | %-10s | %-10s | %-8s | %-10s | %-10s | %-15s | %-15s | %-20s |\n", counter, A.getName(), A.getGender(), A.getStatus(), A.getPoint(), " - ", ((NormalUser)A).getKtp(), " - ", " - " , " - ");
				}
			}
